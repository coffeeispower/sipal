...
impl From<(f64, f64, f64, f64, f64, f64)> for Triangle {
    fn from(triangle: (f64, f64, f64, f64, f64, f64)) -> Self {
        Triangle(Position3(triangle.0, triangle.1, 0.0), Position3(triangle.2, triangle.3, 0.0), Position3(triangle.4, triangle.5, 0.0))
    }
}
impl From<(f64, f64, f64, f64, f64, f64, f64, f64, f64)> for Triangle {
    fn from(triangle: (f64, f64, f64, f64, f64, f64, f64, f64, f64)) -> Self {
        Triangle(Position3(triangle.0, triangle.1, triangle.2), Position3(triangle.3, triangle.4, triangle.5), Position3(triangle.6, triangle.7, triangle.8))
    }
}
impl Triangle {
